...
for(let item of arr) {
    let div_black = document.createElement('div')
    ...
    div_black.classList.add('div-shop')
    div_white.classList.add('div-white')
    h4.classList.add('h4') 
    button.classList.add('button-shop')
    padding.classList.add('div-padding')
   ...
   container.append(div_white)
   div_white.append(img,div_black)
   div_black.append(padding)
   padding.append(h4,br,p,br,button)
